...
TEST(tests, second){
    ...
    std::ofstream file_M;
    std::ofstream file_G;
    file_J.open("/home/ilya/slae_lab/slae/tests/TEST_04_03/test4_data_jacobi.txt");
    file_M.open("/home/ilya/slae_lab/slae/tests/TEST_04_03/test4_data_MPI.txt");
    file_G.open("/home/ilya/slae_lab/slae/tests/TEST_04_03/test4_data_Gauss.txt");
    double tau = 0.0001;
